 ...
 * @author Foundry
 */
public interface CausamConfiguration<C, L, E> {
    Class<C> getContainerType();

    Class<E> getEventType();

    ListenerRegistry<C, L, E> getListenerRegistry();

    Dispatcher<L, E> getDispatcher();

    Iterable<ExceptionHandler> getExceptionHandlers();
}
